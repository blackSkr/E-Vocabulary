        ...
        <div class="max-w-6xl mx-auto px-4 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-lg font-semibold text-gray-800">CivilLex</span>
                    </div>
                    <p class="text-sm text-gray-600 mt-1">UPT Bahasa Language Learning Assistant</p>
                </div>
            ...
            <div class="border-t mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="#" class="text-sm text-gray-600 hover:text-primary transition">Contact Us</a>
                </div>
            </div>
        </div>
    </footer>